...
public class DesarrolladorWS {
    ...
    public int insertarDesarrollador(@WebParam(name = "desarrollador") 
    ...
    public int modificarDesarrollador(@WebParam(name = "desarrollador") 
        Desarrollador desarrollador) {
        boDesarrollador=new DesarrolladorBO();
    ...
    public int eliminarDesarrollador(@WebParam(name = "idDesarrollador") 
        int idDesarrollador) {
        boDesarrollador=new DesarrolladorBO();
    ...
    public Desarrollador obtenerDesarrolladorPorID(@WebParam(name = 
        "idDesarrollador")int idDesarrollador) {
        boDesarrollador=new DesarrolladorBO();
