<%@ Page Title="" Language="C#" MasterPageFile="~/LagStore.Master" AutoEventWireup="true" CodeBehind="EditarComentario.aspx.cs" Inherits="LagStoreWA.EditarComentario" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row">
          <div class="col-md-6">
              ...
              <h5 class="mt-4">Editar Comentario</h5>
              <div class="mb-3">
              ...
              <div class="text-end">
                  <asp:LinkButton ID="btnRegresar" runat="server" CssClass="btn btn-primary" OnClick="btnRegresar_Click">
                        <i class="fa-solid fa-arrow-left"></i> Regresar
                  </asp:LinkButton>
                  <asp:LinkButton ID="btnComentar" runat="server" CssClass="btn btn-primary" OnClick="btnComentar_Click">
