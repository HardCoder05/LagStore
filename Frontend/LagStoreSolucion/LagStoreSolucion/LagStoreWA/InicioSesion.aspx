<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InicioSesion.aspx.cs" Inherits="LagStoreWA.InicioSesion" %>
...
<body>
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
        <div class="card p-4" style="width: 100%; max-width: 400px;">
            ...
            <div class="text-center mt-3">
                <small>¿Eres nuevo? <a href="RegistroUsuario.aspx">Registrar</a></small>
            </div>
        </div>
    </div>
</body>
